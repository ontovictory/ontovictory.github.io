...
// Gift code to show Paragraph of code, replace image and fade out show button
$(document).ready(function () {
  $("#codeshow").click(function () {
    $("#dailycode").show();
    $("#dailycode2").show();
    $("#codeshow").fadeOut("slow");
    $(".dailycodebox").attr("src", "/images/dailycodeboxopen.jpg");
  });
});
...
$tagLink.click(function(evt) {
	...
	if (linkText == "all") {
		...
		$postsTitle.text("Tag Clicked: " + linkText);
		$posts.hide()
			.filter('.' + linkText)
			.show();
	}
